...
public class CardDenuncia extends RecyclerView.Adapter<CardDenuncia.ViewHolder>{
    private final List<Denuncias> mValues;
    public Denuncias usermod;
    private final ListaDenuncias.OnListFragmentInteractionListener mListener;
    private final Context context;

    public CardDenuncia(Context context, List<Denuncias> items, ListaDenuncias.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_card_denuncia, parent, false);
        return new ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(final CardDenuncia.ViewHolder holder, int position) {
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            descripcion_denuncia = view.findViewById(R.id.tv_descripcion);
            estado_denuncia = view.findViewById(R.id.tv_estado);
        }
